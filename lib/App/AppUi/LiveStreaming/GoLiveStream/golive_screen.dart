...
//       "007eJxTYDhhxKSU2r7YTvWHh84MhUWcwWo953cJXrjks9FuMoP9CVcFBssU4yRzc9M0Y2PLFJOUxDSLJEPTNMNk8xSD5GTzNOM0abPNmQ2BjAyTbwayMDJAIIjPx1CSWlySmZfunJGYl5eaw8AAANIIIXQ=";
...
class _GoliveScreenState extends State<GoliveScreen>
  ...
  RtcEngine? _engine; // Nullable banaya taake safety rahe
  final String appId = "5eda14d417924d9baf39e83613e8f8f5";
  final String tempToken =
      "007eJxTYDhhxKSU2r7YTvWHh84MhUWcwWo953cJXrjks9FuMoP9CVcFBssU4yRzc9M0Y2PLFJOUxDSLJEPTNMNk8xSD5GTzNOM0abPNmQ2BjAyTbwayMDJAIIjPx1CSWlySmZfunJGYl5eaw8AAANIIIXQ=";
  ...
  void initState() {
    ...
    // Pehle permissions check karein, phir 1 second baad engine start karein
    _initSequence();
  ...
  Future<void> _initSequence() async {
    await [Permission.camera, Permission.microphone].request();
    // 1 second ka gap taake hardware release ho jaye pichle screen se
    Future.delayed(const Duration(seconds: 1), () {
      if (mounted) initAgoraEngine();
    });
  }
    ...
    Timer.periodic(const Duration(seconds: 1), (timer) {
      ...
      if (countdown.value > 1) {
        ...
        if (isJoined.value) {
          ...
          debugPrint("Still waiting for Agora connection...");
        }
      }
    });
  }
  ...
  Future<void> initAgoraEngine() async {
    try {
      ...
      // Low bitrate settings taake MediaCodec fail na ho
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () => _shutdownHost(),
                        child: Text(
                          isArabic ? "إنهاء" : "END LIVE",
                          style: const TextStyle(
                            color: Colors.white,
                            fontWeight: FontWeight.bold,
                          ),
